...
FROM all_sites
    ...
    LEFT JOIN common_id
        ON common_id."OBJ_MRC" = all_sites."TOMS Site ID"
    LEFT JOIN r5_organizations
        ON r5_organizations."ORG_CODE" = common_id."OBJ_ORG"